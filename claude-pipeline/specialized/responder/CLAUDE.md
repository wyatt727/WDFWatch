...
- The specific episode's topics/guest mentioned in the summary
- OR the broader WDF podcast themes (federalism, state sovereignty, constitutional principles)
...
1. **EPISODE KEY POINTS**: Condensed talking points from recent episodes
   - Guest names and credentials
   - Main topics discussed
   - Key arguments or solutions proposed
...
4. **WHY RELEVANT** (when available): Classification reasoning explaining why this tweet is relevant
   ...
   - If it mentions a specific guest/topic, reference that in your response
